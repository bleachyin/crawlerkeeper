...
class ZKClient(object):
    ...
    def create(self, path, data="", flags=zookeeper.EPHEMERAL, acl=[ZOO_OPEN_ACL_UNSAFE]):
        start = time.time()
    ...
    def create_persistence_node(self,path,data="",acl=[ZOO_OPEN_ACL_UNSAFE]):
        return self.create(path,data,0,acl)
